...
## 🙋‍♂️ About Me
저는 기존에 데이터를 분석하는데에는 흥미가 있었지만, 저의 전공인 통계학 자체에는 큰 흥미가 없었습니다.
하지만 학년이 오르고 전공 지식이 심화됨에 따라 통계학이 데이터를 분석하는데에 매우 좋은 도구가 될 수 있다는 것을 느끼게 되었고,
지금은 통계 지식을 기반으로 R, Python을 활용하여 데이터 속에서 유의미한 관계나 숨겨진 패턴을 찾아내는 일을 즐기고 있습니다.
최근에는 다양한 머신러닝 모델의 성능을 객관적인 지표로 비교 평가하고, '왜' 이 모델이 최적인지 통계적 근거를 들어 설명하는 역량에 집중하고 있습니다.
...
[![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=ANich479&layout=compact&theme=radical&dummy=1)](https://github.com/anuragroy/github-readme-stats)
